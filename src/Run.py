...
def main():
    ...
    mlPred = myMLPlassifier.evaluate()
    ...
    print("\nResult of the Multi Layer recognizer:")
    #evaluator.printComparison(data.testSet, mlPred)
    evaluator.printAccuracy(data.testSet, mlPred)
